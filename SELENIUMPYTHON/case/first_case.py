...
class FirstCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.file_name = "E:/unittest/image/test01.png"
        cls.driver = webdriver.Chrome()
        cls.driver.get("http://www.5itest.cn/register?goto=/course/explore")
    ...
    def test_login_email_error(self):
        email_error = self.login.login_email_error('324324@qq.com','111','111111',self.file_name)
    ...
    def test_login_username_error(self):
        user_name_error = self.login.login_name_error('7788@qq.com','ccc','111111',self.file_name)
